...
functions:staffAttendanceNudges,functions:getMyRange,functions:getMyClients,\
...
Después las funciones. **Hay que desplegar las diecisiete, no solo las nuevas** —
